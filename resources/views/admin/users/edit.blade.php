            ...
            <div class="form">
              <form class="form-validate form-horizontal" id="feedback_form" method="post" action="{{ route('admin.users.update',$user->id) }}">
                ...
                <div class="form-group ">
                  ...
                  <div class="col-lg-10">
                    <input class="form-control" name="name" id="name" name="fullname" minlength="5" type="text" value="{{ $user->name }}" required />
                  </div>
                </div>
                 <div class="form-group ">
                ...
                <div class="form-group ">
                  ...
                  <div class="col-lg-10">
                    <input class="form-control" id="password" name="password" minlength="5" type="password" value="{{ $user->password }}" required />
                  </div>
                </div>
                <div class="form-group ">
                  <label for="cname" class="control-label col-lg-2">Confirm-Password <span class="required">*</span></label>
                  <div class="col-lg-10">
                    <input class="form-control" id="conf-password" value="{{ $user->password }}" name="conf-password" minlength="5" type="password" required />
                  </div>
                </div>
                <div class="form-group">
