      ...
      <div class="col-lg-12">
        <section class="panel">
          ...
          <div class="panel-body">
            <div class="form">
              <form class="form-validate form-horizontal" enctype="multipart/form-data" id="feedback_form" method="post" action="{{ route('products.update',$product->id) }}">
              	{{ csrf_field() }}
              	@if (count($errors) > 0)
                <ul>
                ...
                <div class="form-group ">
                  ...
                  <div class="col-lg-10">
                    <input class="form-control" name="name" id="name" name="fullname" minlength="1" type="text" value="{{$product->name}}" />
                  </div>
                </div>
                <div class="form-group ">
                ...
                <div class="form-group ">
                  ...
                  <div class="col-lg-10">
                    <input class="form-control " id="intro" type="text" name="intro" value="{{$product->intro}}" />
                  </div>
                </div>
                <div class="form-group ">
...
height: 214px;" value="{{$product->description}}"></textarea>
                  </div>
                </div>
                <div class="form-group">
                    ...
                    <img src="{{ asset('/public/img/')}}/{{$product->image}}" width="150px">
	                </div>
                </div>
                ...
                <div class="form-group">
                  <div class="col-lg-offset-2 col-lg-10">
                    ...
                    <button class="btn btn-default" type="button" onclick="window.location='{{ route('products.list') }}'">Cancel</button>
                  </div>
                </div>
              </form>
            </div>
