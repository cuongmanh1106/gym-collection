<div class="agileheader" id="agileitshome">
								...
								<div class="row">
									...
									<div class="col-sm-3 w3layouts-nav-agile w3layouts-mens-nav-agileits w3layouts-mens-nav-agileits-1">
										<ul class="multi-column-dropdown">
											...
											<li><a href="{{ route('products.show') }}"><i class="fa fa-angle-right" aria-hidden="true"></i>New Arrivals</a></li>
									...
									<div class="col-sm-3 w3layouts-nav-agile w3layouts-mens-nav-agileits w3layouts-mens-nav-agileits-2">
										<p>TORSO</p>
										<a href="mens.html"><img src="{{ asset('/public/display/images/men-nav-1.jpg') }}" alt="Groovy Apparel"></a>
									</div>

									<div class="col-sm-3 w3layouts-nav-agile w3layouts-mens-nav-agileits w3layouts-mens-nav-agileits-3">
										<p>LEGS</p>
										<a href="mens.html"><img src="{{ asset('/public/display/images/men-nav-2.jpg') }}" alt="Groovy Apparel"></a>
									</div>

									<div class="col-sm-3 w3layouts-nav-agile w3layouts-mens-nav-agileits w3layouts-mens-nav-agileits-4">
										<p>ACCESSORIES</p>
										<a href="mens_accessories.html"><img src="{{ asset('/public/display/images/men-nav-3.jpg') }}" alt="Groovy Apparel"></a>
									</div>
							...
							<ul class="dropdown-menu multi multi2">
								<div class="row">
									...
									<div class="col-sm-3 w3layouts-nav-agile w3layouts-womens-nav-agileits w3layouts-womens-nav-agileits-2">
										<p>TOP</p>
										<a href="womens.html"><img src="{{ asset('/public/display/images/women-nav-1.jpg') }}" alt="Groovy Apparel"></a>
									</div>

									<div class="col-sm-3 w3layouts-nav-agile w3layouts-womens-nav-agileits w3layouts-womens-nav-agileits-3">
										<p>LEGS</p>
										<a href="womens.html"><img src="{{ asset('/public/display/images/women-nav-2.jpg') }}" alt="Groovy Apparel"></a>
									</div>

									<div class="col-sm-3 w3layouts-nav-agile w3layouts-womens-nav-agileits w3layouts-womens-nav-agileits-4">
										<p>ACCESSORIES</p>
										<a href="womens_accessories.html"><img src="{{ asset('/public/display/images/women-nav-3.jpg') }}" alt="Groovy Apparel"></a>
									</div>
							...
							<ul class="dropdown-menu multi multi3">
								<div class="row">
									...
									<div class="col-sm-3 w3layouts-nav-agile w3layouts-acc-nav-agileits w3layouts-acc-nav-agileits-2">
										<p>MEN</p>
										<a href="mens_accessories.html"><img src="{{ asset('/public/display/images/other-nav-1.jpg') }}" alt="Groovy Apparel"></a>
									</div>

									<div class="col-sm-3 w3layouts-nav-agile w3layouts-acc-nav-agileits w3layouts-acc-nav-agileits-3">
										<p>WOMEN</p>
										<a href="womens_accessories.html"><img src="{{ asset('/public/display/images/other-nav-2.jpg') }}" alt="Groovy Apparel"></a>
									</div>

									<div class="col-sm-3 w3layouts-nav-agile w3layouts-acc-nav-agileits w3layouts-acc-nav-agileits-4">
										<p>ACCESSORIES</p>
										<a href="mens_accessories.html"><img src="{{ asset('/public/display/images/other-nav-3.jpg') }}" alt="Groovy Apparel"></a>
									</div>
							...
							<ul class="dropdown-menu multi multi4">
								<div class="row">
									...
									<div class="col-sm-3 w3layouts-nav-agile w3layouts-hot-nav-agileits w3layouts-hot-nav-agileits-2">
										<p>MEN</p>
										<a href="mens.html"><img src="{{ asset('/public/display/images/other-nav-1.jpg') }}" alt="Groovy Apparel"></a>
									</div>

									<div class="col-sm-3 w3layouts-nav-agile w3layouts-hot-nav-agileits w3layouts-hot-nav-agileits-3">
										<p>WOMEN</p>
										<a href="womens.html"><img src="{{ asset('/public/display/images/other-nav-2.jpg') }}" alt="Groovy Apparel"></a>
									</div>
	...
	<!-- <div class="agilemodel-slider">
		<div id='film_roll_1'>
			<div><img src="{{ asset('/public/display/images/model_slide-1.jpg') }}" alt="Groovy Apparel"></div>
			<div><img src="{{ asset('/public/display/images/model_slide-2.jpg') }}" alt="Groovy Apparel"></div>
			<div><img src="{{ asset('/public/display/images/model_slide-3.jpg') }}" alt="Groovy Apparel"></div>
			<div><img src="{{ asset('/public/display/images/model_slide-4.jpg') }}" alt="Groovy Apparel"></div>
			<div><img src="{{ asset('/public/display/images/model_slide-5.jpg') }}" alt="Groovy Apparel"></div>
			<div><img src="{{ asset('/public/display/images/model_slide-6.jpg') }}" alt="Groovy Apparel"></div>
			<div><img src="{{ asset('/public/display/images/model_slide-7.jpg') }}" alt="Groovy Apparel"></div>
			<div><img src="{{ asset('/public/display/images/model_slide-8.jpg') }}" alt="Groovy Apparel"></div>
			<div><img src="{{ asset('/public/display/images/model_slide-9.jpg') }}" alt="Groovy Apparel"></div>
			<div><img src="{{ asset('/public/display/images/model_slide-10.jpg') }}" alt="Groovy Apparel"></div>
		</div>
	</div> -->