						...
						<a href="womens_single.html">
							<div class="cbp-pgitem a3ls">
								<div class="cbp-pgitem-flip">
									<img src="{{ asset('/public/display/images/11-front.jpg') }}" alt="Groovy Apparel">
									<img src="{{ asset('/public/display/images/11-back.jpg') }}" alt="Groovy Apparel">
								</div>
							</div>
						</a>
				...
				<li class="wthree aits w3l">
					<div class="cbp-pgcontent" id="women-2">
						...
						<a href="womens_single.html">
							<div class="cbp-pgitem a3ls">
								<div class="cbp-pgitem-flip">
									<img src="{{ asset('/public/display/images/12-front.jpg') }}" alt="Groovy Apparel">
									<img src="{{ asset('/public/display/images/12-back.jpg') }}" alt="Groovy Apparel">
								</div>
							</div>
						</a>
						<ul class="cbp-pgoptions w3l">
				...
				<li class="wthree aits w3l">
					<div class="cbp-pgcontent" id="women-3">
						...
						<a href="womens_single.html">
							<div class="cbp-pgitem a3ls">
								<div class="cbp-pgitem-flip">
									<img src="{{ asset('/public/display/images/13-front.jpg') }}" alt="Groovy Apparel">
									<img src="{{ asset('/public/display/images/13-back.jpg') }}" alt="Groovy Apparel">
								</div>
							</div>
						</a>
						<ul class="cbp-pgoptions w3l">
				...
				<li class="wthree aits w3l">
					<div class="cbp-pgcontent" id="women-4">
						...
						<a href="womens_single.html">
							<div class="cbp-pgitem a3ls">
								<div class="cbp-pgitem-flip">
									<img src="{{ asset('/public/display/images/14-front.jpg') }}" alt="Groovy Apparel">
									<img src="{{ asset('/public/display/images/14-back.jpg') }}" alt="Groovy Apparel">
								</div>
							</div>
						</a>
						<ul class="cbp-pgoptions w3l">
				...
				<li class="wthree aits w3l">
					<div class="cbp-pgcontent" id="women-5">
						...
						<a href="womens_single.html">
							<div class="cbp-pgitem a3ls">
								<div class="cbp-pgitem-flip">
									<img src="{{ asset('/public/display/images/15-front.jpg') }}" alt="Groovy Apparel">
									<img src="{{ asset('/public/display/images/15-back.jpg') }}" alt="Groovy Apparel">
								</div>
							</div>
						</a>
						<ul class="cbp-pgoptions w3l">
							...
							<li class="cbp-pgoptcart">
								<button class="btn btn-danger agileits my-cart-btn" data-id="women-5" data-name="Blue Legging" data-summary="Blue Legging" data-price="17" data-quantity="1" data-image="{{ asset('/public/display/images/15-front.jpg') }}"><i class="fa fa-cart-plus" aria-hidden="true"></i></button>
							</li>
						</ul>
					</div>
					<a href="womens_single.html">
				...
				<li class="wthree aits w3l">
					<div class="cbp-pgcontent" id="women-6">
						...
						<a href="womens_single.html">
							<div class="cbp-pgitem a3ls">
								<div class="cbp-pgitem-flip">
									<img src="{{ asset('/public/display/images/16-front.jpg') }}" alt="Groovy Apparel">
									<img src="{{ asset('/public/display/images/16-back.jpg') }}" alt="Groovy Apparel">
								</div>
							</div>
						</a>
						<ul class="cbp-pgoptions w3l">
				...
				<li class="wthree aits w3l">
					<div class="cbp-pgcontent" id="women-7">
						...
						<a href="womens_single.html">
							<div class="cbp-pgitem a3ls">
								<div class="cbp-pgitem-flip">
									<img src="{{ asset('/public/display/images/17-front.jpg') }}" alt="Groovy Apparel">
									<img src="{{ asset('/public/display/images/17-back.jpg') }}" alt="Groovy Apparel">
								</div>
							</div>
						</a>
						<ul class="cbp-pgoptions w3l">
				...
				<li class="wthree aits w3l">
					<div class="cbp-pgcontent" id="women-8">
						...
						<a href="womens_single.html">
							<div class="cbp-pgitem a3ls">
								<div class="cbp-pgitem-flip">
									<img src="{{ asset('/public/display/images/18-front.jpg') }}" alt="Groovy Apparel">
									<img src="{{ asset('/public/display/images/18-back.jpg') }}" alt="Groovy Apparel">
								</div>
							</div>
						</a>
						<ul class="cbp-pgoptions w3l">
